...
export default class BTCarts extends Component {
    ...
    tinhTongSoLuongGioHang = () => this.state.gioHang.reduce((tongSoLuong, spGH, index) => tongSoLuong+= spGH.soLuong,0)
      ...
      <div className="container">
        ...
        <div className="text-right">
          <button
            ...
            data-target="#modelId"
          >
            <i className="fa fa-cart-plus" aria-hidden="true"></i>({this.tinhTongSoLuongGioHang()}) Giỏ hàng
          </button>
        </div>
        <BTCartModal gioHang={this.state.gioHang} tinhTongTien={this.tinhTongTien}/>
        <BTProductList dataPhone={this.dataPhone} themGioHang={this.themGioHang}/>
      </div>
    );
  }
}
